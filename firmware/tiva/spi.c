...
void kickoff_transfers() {
	...
	if(BUS_COUNT >= 1) kickoff_transfer(11, 0, SSI0_BASE);
	if(BUS_COUNT >= 2) kickoff_transfer(25, 1, SSI1_BASE);
	if(BUS_COUNT >= 3) kickoff_transfer(13, 2, SSI2_BASE);
	if(BUS_COUNT >= 4) kickoff_transfer(15, 3, SSI3_BASE);
}
